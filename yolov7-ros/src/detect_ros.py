...
from yolov7_ros.msg import yolo_class # ADDED
...
class Yolov7Publisher:
    def __init__(self, img_topic: str, weights: str, conf_thresh: float = 0.5,
        ...
        self.class_publisher = rospy.Publisher('yolo_class_num', yolo_class, queue_size=10) # ADDED
    ...
    def process_img_msg(self, img_msg: Image):
        ...
        if self.visualization_publisher:
            ...
            # print(classes)
            self.class_publisher.publish(classes[0]) # ADDED
            ### publish
...
if __name__ == "__main__":
    ...
    rospy.init_node("yolov7_class_num") # ADDED
