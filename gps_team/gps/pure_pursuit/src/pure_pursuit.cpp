...
PurePursuit::PurePursuit() : 
  ...
  left_go_flag(false), is_obstacle_detected_8m(0), is_finish(false) , is_delivery_obs_stop_detected(0) , is_delivery_obs_calc_detected(0), emergencylight_flag(false){}
